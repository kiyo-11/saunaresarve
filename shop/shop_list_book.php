...
<html lang="ja">
    ...
    <body>
        ...
        <?php
            ...
            $sql ="select * from sauna where gaiki='".$gaiki."' and rouryu='".$rouryu."' and price BETWEEN 0 AND ".$price." and sauna BETWEEN 0 AND ".$sauna." and water BETWEEN 0 AND ".$water."";
        ...
        ?>
        <a href='../shop/index.php'>トップへ戻る</a>
        <br><br>
